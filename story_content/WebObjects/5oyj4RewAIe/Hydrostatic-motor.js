...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || '__URL__Hydrostatic-motor.gltf'.replace('__URL__', ''),
...
function prepareExternalInterface(app) {
    app.ExternalInterface.passvariablerothorclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("rothorclicked","Vrai");
    return myVar;
    }
    app.ExternalInterface.passvariablerothornotclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("rothorclicked","Faux");
    return myVar;
    }
    app.ExternalInterface.passvariablerotantihorclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("rotantihorclicked","Vrai");
    return myVar;
    }
    app.ExternalInterface.passvariablerotantihornotclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("rotantihorclicked","Faux");
    return myVar;
    }
    app.ExternalInterface.passvariablestopclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("stopclicked","Vrai");
    return myVar;
    }
    app.ExternalInterface.passvariablestopnotclicked = function() {
    var player=parent.GetPlayer();
    var myVar = player.SetVar("stopclicked","Faux");
    return myVar;
    }
}
...
function runCode(app) {
    window.rothorclicked = function() {
    v3d.puzzles.procedures.rothorclicked();
    }
    window.rothornotclicked = function() {
    v3d.puzzles.procedures.rothornotclicked();
    }
    window.rotantihorclicked = function() {
    v3d.puzzles.procedures.rotantihorclicked();
    }
    window.rotantihornotclicked = function() {
    v3d.puzzles.procedures.rotantihornotclicked();
    }
    window.stopclicked = function() {
    v3d.puzzles.procedures.stopclicked();
    }
    window.stopnotclicked = function() {
    v3d.puzzles.procedures.stopnotclicked();
    }
}
